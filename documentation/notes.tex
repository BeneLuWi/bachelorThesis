...
\item Ein Knoten des Grades k+1 (|Lösungsmenge|$\leq$ k ) wird automatisch hinzugefügt, da sonst k+1 Elemente in der Menge wären s54
\end{itemize}
...
VC(B) = CB mit Satz von König bestimmen (mcb_machting)
VC(G[V0]) $\cup$ C0 = VC(G)
